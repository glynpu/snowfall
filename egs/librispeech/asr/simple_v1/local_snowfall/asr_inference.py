...
class Speech2Text:
    ...
    def __call__(
        ...
        nnet_output, supervision = self.asr_model.encode(**batch)
        ...
        print(token_int)
        import pdb; pdb.set_trace()
        # token_int: [10, 2668, 53, 60, 26, 996, 242, 20, 1002, 552, 1118, 3, 4, 409, 251, 22, 3, 4, 434, 389, 2117, 4840, 4, 1839, 354, 334, 292, 1852, 6, 26, 1218, 341, 65, 8, 1049, 3779, 13, 2551, 1839, 833, 3753]
        # token:['_HE', '_HOPED', '_THERE', '_WOULD', '_BE', '_STE', 'W', '_FOR', '_DINNER', '_TURN', 'IP', 'S', '_AND', '_CAR', 'RO', 'T', 'S','_AND', '_B', 'RU', 'ISED', '_POTATOES', '_AND', '_FAT', '_M', 'UT', 'TON', '_PIECES', '_TO', '_BE', '_LAD', 'LED', '_OUT', '_IN', '_THICK', '_PEPPER', 'ED', '_FLOUR', '_FAT', 'TEN', '_SAUCE']
